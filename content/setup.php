<?php
/**
 * Demo site setup for MåleriVision Sthlm AB.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'MåleriVision Sthlm AB' );
...
$home = nps_page(
	...
	nps_pattern( 'malerivisionsthlm/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'malerivisionsthlm/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'malerivisionsthlm/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'malerivisionsthlm/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'malerivisionsthlm/thank-you' ),
...
<p class="has-large-font-size">MåleriVision Sthlm AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om MåleriVision Sthlm AB', $about_content . "\n\n" . nps_pattern( 'malerivisionsthlm/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'malerivisionsthlm/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder MåleriVision Sthlm AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'MåleriVision Sthlm AB demo ready.' );
