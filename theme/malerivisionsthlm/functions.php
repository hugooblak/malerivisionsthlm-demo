<?php
/**
 * MåleriVision Sthlm AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "MåleriVision Sthlm AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through ma_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'malerivisionsthlm', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'malerivisionsthlm' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'malerivisionsthlm' ) ) );

		register_block_pattern_category( 'malerivisionsthlm-sections', array( 'label' => __( 'MåleriVision Sthlm AB sections', 'malerivisionsthlm' ) ) );
		register_block_pattern_category( 'malerivisionsthlm-pages', array( 'label' => __( 'MåleriVision Sthlm AB page layouts', 'malerivisionsthlm' ) ) );
	}
);
